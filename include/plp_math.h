...
/** -------------------------------------------------------
    @struct plp_dot_prod_instance_i8
    @brief Instance structure for short integer parallel dot product.
    @param[in]  pSrcA      points to the first input vector
    @param[in]  pSrcB      points to the second input vector
    @param[in]  blkSizePE  number of samples in each vector
...
void plp_dot_prod_i8_parallel(const int8_t *__restrict__ pSrcA,
                               const int8_t *__restrict__ pSrcB,
                               uint32_t blockSize,
                               uint32_t nPE,
                               int32_t *__restrict__ pRes);
...
/** -------------------------------------------------------
    @brief Glue code for parallel dot product of 8-bit fixed point vectors.
    @param[in]  pSrcA      points to the first input vector
    @param[in]  pSrcB      points to the second input vector
    @param[in]  blockSize  number of samples in each vector
    @param[in]  deciPoint  decimal point for right shift
...
void plp_dot_prod_q8_parallel(const int8_t *__restrict__ pSrcA,
                               const int8_t *__restrict__ pSrcB,
                               uint32_t blockSize,
                               uint32_t deciPoint,
                               uint32_t nPE,
...
/** -------------------------------------------------------
    @brief Parallel dot product with interleaved access of 8-bit integer vectors kernel for XPULPV2
    extension.
    @param[in]  S     points to the instance structure for short integer parallel dot product
    @return     none
*/
