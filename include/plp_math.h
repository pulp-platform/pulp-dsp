...
void plp_var_i16s_rv32im(const int16_t *__restrict__ pSrc,
                         uint32_t blockSize,
                         int32_t *__restrict__ pRes);
...
void plp_var_i16s_xpulpv2(const int16_t *__restrict__ pSrc,
                          uint32_t blockSize,
                          int32_t *__restrict__ pRes);
...
void plp_var_i8s_rv32im(const int8_t *__restrict__ pSrc,
                        uint32_t blockSize,
                        int32_t *__restrict__ pRes);
