...
if __name__=='__main__':
    ...
    f.write('#ifndef __FFT_SWAP_TABLE_H_' + '__\n#define __FFT_SWAP_TABLE_H_'  + '__\n\n')

    lengths = np.array([8, 16, 32, 64, 128, 256, 512])
    ...
    for i in lengths:
        ...
        write_arr(f, 'SwapTable_' + str(i), swaptable, 'int16_t', i)
