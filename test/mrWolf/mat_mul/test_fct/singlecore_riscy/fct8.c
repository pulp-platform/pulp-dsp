        ...
        for(i=0; i < M/2; i++){
          for(k=0; k < O/4; k++){
            ...
            for(j=0; j<N/4; j++){
              ...
              // int8_t BVal00 = pSrcB[(j*4  )*O+(k*4  )];
              // int8_t BVal01 = pSrcB[(j*4  )*O+(k*4+1)];
              // int8_t BVal02 = pSrcB[(j*4  )*O+(k*4+2)];
              // int8_t BVal03 = pSrcB[(j*4  )*O+(k*4+3)];
              v4s temp0 = *((v4s*)&(pSrcB[(j*4  )*O + (k*4  )]));

              // int8_t BVal10 = pSrcB[(j*4+1)*O+(k*4  )];
              // int8_t BVal11 = pSrcB[(j*4+1)*O+(k*4+1)];
              // int8_t BVal12 = pSrcB[(j*4+1)*O+(k*4+2)];
              // int8_t BVal13 = pSrcB[(j*4+1)*O+(k*4+3)];
              v4s temp1 = *((v4s*)&(pSrcB[(j*4+1)*O + (k*4  )]));

              // int8_t BVal20 = pSrcB[(j*4+2)*O+(k*4  )];
              // int8_t BVal21 = pSrcB[(j*4+2)*O+(k*4+1)];
              // int8_t BVal22 = pSrcB[(j*4+2)*O+(k*4+2)];
              // int8_t BVal23 = pSrcB[(j*4+2)*O+(k*4+3)];
              v4s temp2 = *((v4s*)&(pSrcB[(j*4+2)*O + (k*4  )]));

              // int8_t BVal30 = pSrcB[(j*4+3)*O+(k*4  )];
              // int8_t BVal31 = pSrcB[(j*4+3)*O+(k*4+1)];
              // int8_t BVal32 = pSrcB[(j*4+3)*O+(k*4+2)];
              // int8_t BVal33 = pSrcB[(j*4+3)*O+(k*4+3)];
              ...
              // v4s bVec2 = {BVal02, BVal12 ,BVal22 ,BVal32};
              // v4s bVec3 = {BVal03, BVal13 ,BVal23 ,BVal33};
