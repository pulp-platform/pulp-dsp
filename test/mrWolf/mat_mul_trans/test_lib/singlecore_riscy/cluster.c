...
static void do_bench_0(rt_perf_t *perf, int events)
{
  ...
  #if defined (P_TEST_8)
    plp_mat_mult_trans_i8_parallel(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, rt_nb_pe(), result);
  #elif defined (P_TEST_16)
    plp_mat_mult_trans_i16_parallel(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, rt_nb_pe(), result);
  #elif defined (P_TEST_32)
    plp_mat_mult_trans_i32_parallel(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, rt_nb_pe(), result);
  #elif defined (TEST_8)
    plp_mat_mult_trans_i8(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, result);
  #elif defined(TEST_16)
    plp_mat_mult_trans_i16(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, result);
  #else
    plp_mat_mult_trans_i32(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, result);
  #endif
