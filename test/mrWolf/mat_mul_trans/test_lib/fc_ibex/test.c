...
static void do_bench_0(rt_perf_t *perf, int events)
{
  ...
  #if defined(P_MUL_TEST_8)
    plp_mat_mult_trans_i8_parallel(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, 8, result);
  #elif defined(P_MUL_TEST_16)
    plp_mat_mult_trans_i16_parallel(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, 8, result);
  #elif defined(P_MUL_TEST_32)
    plp_mat_mult_trans_i32_parallel(m_a, m_b, M_LENGTH, N_LENGTH, O_LENGTH, 8, result);
  #elif defined(MUL_TEST_8)
