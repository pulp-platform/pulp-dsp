 ...
 * Description:  16-bit integer vectorized parallel complex fast fourier transform for XPULPV2 and CPLX extensions
 *
 * $Date:        18. July 2019
 * $Revision:    V0
 *
...
void plp_cfft_i16vp_xpulpv2cplx(void * S)
{
    ...
    uint32_t N_FFT = (int32_t)(((plp_cfft_instance_i16 *)S)->N_FFT);
