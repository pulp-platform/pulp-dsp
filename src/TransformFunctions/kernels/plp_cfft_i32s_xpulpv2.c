 ...
 * Title:        plp_cfft_i32s_xpulpv2.c
 * Description:  32-bit integer scalar complex fourier transform for XPULPV2
 *
 * $Date:        19. July 2019
 * $Revision:    V0
 *
...
void plp_cfft_i32s_xpulpv2(int32_t *__restrict__ Data, int32_t *__restrict__ Twiddles, uint16_t * SwapTable, uint32_t N_FFT)
{
