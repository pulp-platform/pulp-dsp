 ...
 * Title:        plp_mat_mult_cmplx_q32p_xpulpv2.c
 * Description:  parallel 32-bit fix-point complex matrix matrix multiplication for XPULPV2
 *
...
/**
  ...
  @param[in]  args  pointer to plp_mat_mat_mult_cmplx_instance_q32 struct initialized by
