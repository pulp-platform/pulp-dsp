 ...
 * Title:        plp_mat_mult_cmplx_i16vp_xpulpv2.c
 * Description:  parallel 16-bit integer complex matrix matrix multiplication for XPULPV2
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
/**
  ...
  @param[in]  args  pointer to plp_mat_mat_mult_cmplx_instance_i16 struct initialized by
...
void plp_mat_mult_cmplx_i16vp_xpulpv2(void *args) {
    ...
    plp_mat_mult_cmplx_instance_i16 *a = (plp_mat_mult_cmplx_instance_i16 *)args;
