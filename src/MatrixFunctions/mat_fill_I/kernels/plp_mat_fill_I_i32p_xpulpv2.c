 ...
 * Title:        plp_mat_fill_I_i32p_xpulpv2.c
 * Description:  parallel 32-bit integer identity matrix creation for XPULPV2
 *
...
/**
  ...
  @param[in]  args  pointer to plp_mat_mat_fill_I_instance_i32 struct initialized by
...
void plp_mat_fill_I_i32p_xpulpv2(void *args) {
    ...
    plp_mat_fill_I_instance_i32 *a = (plp_mat_fill_I_instance_i32 *)args;
