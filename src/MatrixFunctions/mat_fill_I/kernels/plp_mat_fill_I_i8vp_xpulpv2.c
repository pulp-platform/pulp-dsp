 ...
 * Title:        plp_mat_fill_I_i8vp_xpulpv2.c
 * Description:  parallel 8-bit integer identity matrix creation for XPULPV2
 *
 * $Date:        16. July 2020
 * $Revision:    V0
 *
...
/**
  ...
  @param[in]  args  pointer to plp_mat_mat_fill_I_instance_i8 struct initialized by
...
void plp_mat_fill_I_i8vp_xpulpv2(void *args) {
    ...
    plp_mat_fill_I_instance_i8 *a = (plp_mat_fill_I_instance_i8 *)args;
