 ...
 * Title:        plp_mat_fill_I_i16s_rv32im.c
 * Description:  16-bit identity matrix creation kernel for RV32IM
 *
 * $Date:        16. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatFillIKernels Identity Matrix Creation Kernels
  ...
  `plp_mat_mat_fill_I_i32s_xpulpv2`):
