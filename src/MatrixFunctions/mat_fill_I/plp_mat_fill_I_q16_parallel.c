 ...
 * Title:        plp_mat_fill_I_q16_parallel.c
 * Description:  parallel 16-bit fix-point identity matrix creation glue code
 *
 * $Date:        16. July 2020
 * $Revision:    V0
 *
...
void plp_mat_fill_I_q16_parallel(uint32_t N,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_fill_I_instance_q16 args = {
            .N = N, .fracBits = fracBits, .nPE = nPE, .pDst = pDst
        };

        hal_cl_team_fork(nPE, plp_mat_fill_I_q16p_xpulpv2, (void *)&args);
    }
}
