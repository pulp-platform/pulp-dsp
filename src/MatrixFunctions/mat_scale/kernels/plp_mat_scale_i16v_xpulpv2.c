 ...
 * Title:        plp_mat_scale_i16v_xpulpv2.c
 * Description:  16-bit integer matrix scale for XPULPV2
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix scale of 16-bit integer matrices kernel for XPULPV2 extension.
