 ...
 * Title:        plp_mat_scale_i32s_rv32im.c
 * Description:  32-bit matrix scale kernel for RV32IM
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix scale of 32-bit integer matrices kernel for RV32IM extension.
