 ...
 * Title:        plp_mat_scale_i8s_rv32im.c
 * Description:  8-bit matrix scale kernel for RV32IM
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix scale of 8-bit integer matrices kernel for RV32IM extension.
