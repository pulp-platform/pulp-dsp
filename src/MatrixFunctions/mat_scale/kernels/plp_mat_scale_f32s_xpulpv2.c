 ...
 * Title:        plp_mat_scale_f32s_xpulpv2.c
 * Description:  32-bit floating-point matrix scale for XPULPV2
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix scale of 32-bit floating-point matrices kernel for XPULPV2 extension.
