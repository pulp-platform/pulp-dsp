 ...
 * Title:        plp_mat_trans_i32s_rv32im.c
 * Description:  32-bit matrix transpose kernel for RV32IM
 *
 * $Date:        14. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix transpose of 32-bit integer matrices kernel for RV32IM extension.
