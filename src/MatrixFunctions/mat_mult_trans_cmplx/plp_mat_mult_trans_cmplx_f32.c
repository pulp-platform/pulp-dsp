 ...
 * Title:        plp_mat_mult_trans_cmplx_f32.c
 * Description:  32-bit floating-point complex matrix transpose matrix multiplication glue code
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
void plp_mat_mult_trans_cmplx_f32(const float *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_trans_cmplx_f32s_xpulpv2(pSrcA, pSrcB, M, N, O, pDstC);
    }
}
