 ...
 * Title:        plp_mat_mult_trans_cmplx_i32p_xpulpv2.c
 * Description:  parallel 32-bit integer complex matrix transpose matrix multiplication for XPULPV2
 *
 * $Date:        complex matrix transpose matrix multiplication
 * $Revision:    V0
 *
...
/**
  ...
  @param[in]  args  pointer to plp_mat_mat_mult_trans_cmplx_instance_i32 struct initialized by
...
void plp_mat_mult_trans_cmplx_i32p_xpulpv2(void *args) {
    ...
    plp_mat_mult_cmplx_instance_i32 *a = (plp_mat_mult_cmplx_instance_i32 *)args;
