 ...
 * Title:        plp_mat_mult_trans_cmplx_i16s_rv32im.c
 * Description:  16-bit complex matrix transpose matrix multiplication kernel for RV32IM
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatMultTransCmplxKernels Complex Matrix Transpose Matrix Multiplication Kernels
  ...
  `plp_mat_mult_trans_cmplx_i32s_xpulpv2`):
