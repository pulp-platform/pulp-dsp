 ...
 * Title:        plp_mat_mult_trans_cmplx_f32_parallel.c
 * Description:  parallel 32-bit floating-point complex matrix transpose matrix multiplication glue
 * code
 *
 * $Date:        17. July 2020
 * $Revision:    V0
...
void plp_mat_mult_trans_cmplx_f32_parallel(const float *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        hal_cl_team_fork(nPE, plp_mat_mult_trans_cmplx_f32p_xpulpv2, (void *)&args);
    }
}
