 ...
 * Title:        plp_mat_mult_trans_cmplx_q16_parallel.c
 * Description:  parallel 16-bit fix-point complex matrix transpose matrix multiplication glue code
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
void plp_mat_mult_trans_cmplx_q16_parallel(const int16_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_cmplx_instance_q16 args = { .pSrcA = pSrcA,
                                                 .pSrcB = pSrcB,
                                                 .M = M,
                                                 .N = N,
                                                 .O = O,
        ...
        hal_cl_team_fork(nPE, plp_mat_mult_trans_cmplx_q16p_xpulpv2, (void *)&args);
    }
}
