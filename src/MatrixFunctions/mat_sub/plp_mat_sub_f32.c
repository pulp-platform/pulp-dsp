 ...
 * Title:        plp_mat_sub_f32.c
 * Description:  32-bit floating-point matrix subtraction glue code
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for matrix subtraction of 32-bit floating-point matrices.
...
void plp_mat_sub_f32(const float * __restrict__ pSrcA,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID){
        ...
        plp_mat_sub_f32s_xpulpv2(pSrcA, pSrcB, M, N, pDst);
    }
