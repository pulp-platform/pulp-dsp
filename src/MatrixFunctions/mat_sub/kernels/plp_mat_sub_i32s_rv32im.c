 ...
 * Title:        plp_mat_sub_i32s_rv32im.c
 * Description:  32-bit matrix subtraction kernel for RV32IM
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix subtraction of 32-bit integer matrices kernel for RV32IM extension.
