 ...
 * Title:        plp_mat_sub_i8vp_xpulpv2.c
 * Description:  parallel 8-bit integer matrix subtraction for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
void plp_mat_sub_i8vp_xpulpv2(void* args) {
    ...
    plp_mat_sub_instance_i8* a = (plp_mat_sub_instance_i8*)args;
