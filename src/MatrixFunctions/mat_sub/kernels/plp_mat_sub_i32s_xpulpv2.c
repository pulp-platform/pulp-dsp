 ...
 * Title:        plp_mat_sub_i32s_xpulpv2.c
 * Description:  32-bit integer matrix subtraction for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix subtraction of 32-bit integer matrices kernel for XPULPV2 extension.
