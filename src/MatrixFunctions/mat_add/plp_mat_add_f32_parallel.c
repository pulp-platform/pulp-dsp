 ...
 * Title:        plp_mat_add_f32_parallel.c
 * Description:  parallel 32-bit floating-point matrix addition glue code
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for parallel matrix addition of 32-bit floating-point matrices.
...
void plp_mat_add_f32_parallel(const float * __restrict__ pSrcA,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID){
        ...
        plp_mat_add_instance_f32 args = {.pSrcA = pSrcA,
                                         .pSrcB = pSrcB,
                                         .M = M,
                                         .N = N,
                                         .nPE = nPE,
        ...
        rt_team_fork(nPE, plp_mat_add_f32p_xpulpv2, (void*) &args);
    }
