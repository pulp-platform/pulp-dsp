 ...
 * Title:        plp_mat_add_f32s_xpulpv2.c
 * Description:  32-bit floating-point matrix addition for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix addition of 32-bit floating-point matrices kernel for XPULPV2 extension.
