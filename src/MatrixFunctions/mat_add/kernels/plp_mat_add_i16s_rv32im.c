 ...
 * Title:        plp_mat_add_i16s_rv32im.c
 * Description:  16-bit matrix addition kernel for RV32IM
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatAddKernels matrix addition Kernels
  The Matrx Addition adds two matrices, element wise. Both matrices, and the
  output matrix have dimension MxN.
...
/**
  @brief matrix addition of 16-bit integer matrices kernel for RV32IM extension.
