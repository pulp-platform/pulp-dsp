 ...
 * Title:        plp_mat_add_i16vp_xpulpv2.c
 * Description:  parallel 16-bit integer matrix addition for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
void plp_mat_add_i16vp_xpulpv2(void* args) {
    ...
    plp_mat_add_instance_i16* a = (plp_mat_add_instance_i16*)args;
