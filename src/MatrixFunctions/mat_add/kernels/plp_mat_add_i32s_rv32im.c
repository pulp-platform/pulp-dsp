 ...
 * Title:        plp_mat_add_i32s_rv32im.c
 * Description:  32-bit matrix addition kernel for RV32IM
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix addition of 32-bit integer matrices kernel for RV32IM extension.
