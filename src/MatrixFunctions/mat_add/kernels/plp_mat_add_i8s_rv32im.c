 ...
 * Title:        plp_mat_add_i8s_rv32im.c
 * Description:  8-bit matrix addition kernel for RV32IM
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief matrix addition of 8-bit integer matrices kernel for RV32IM extension.
