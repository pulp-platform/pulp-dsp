 ...
 * Title:        plp_mat_add_f32p_xpulpv2.c
 * Description:  parallel 32-bit floating-point matrix addition for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
void plp_mat_add_f32p_xpulpv2(void* args) {
    ...
    plp_mat_add_instance_f32* a = (plp_mat_add_instance_f32*)args;
