 ...
 * Title:        plp_mat_mult_i8.c
 * Description:  8-bit integer matrix multiplication glue code
 *
 * $Date:        18. July 2019
 * $Revision:    V0
 *
...
/**
  @brief Glue code for matrix mutliplication of 8-bit integer matrices.
...
void plp_mat_mult_i8(
  ...
  if (rt_cluster_id() == ARCHI_FC_CID){
    plp_mat_mult_i8s_rv32im(pSrcA, pSrcB, M, N, O, pDstC);
  }
  else{
    plp_mat_mult_i8v_xpulpv2(pSrcA, pSrcB, M, N, O, pDstC);
  }
