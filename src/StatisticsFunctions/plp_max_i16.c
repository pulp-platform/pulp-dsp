 ...
 * Title:        plp_max_i16.c
 * Description:  Maximum value of a 16-bit integer vector glue code
 *
 * $Date:        29.06.2020        
 *
...
/**
   @defgroup max Max
   Calculates the maximum of the input vector. Max is defined as the the greatest value in the vector.
...
void plp_max_i16(
  ...
  if (rt_cluster_id() == ARCHI_FC_CID){
    plp_max_i16s_rv32im(pSrc, blockSize, pRes);
  }
  else{
    plp_max_i16s_xpulpv2(pSrc, blockSize, pRes);
  }
