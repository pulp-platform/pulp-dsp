 ...
 * Title:        plp_var_q32s_rv32im.c
 * Description:  Kernel to calculate the variance of a 32-bit fixed point vector glue code on RV32IM
 *
 * $Date:        30.06.2020
 *
...
/**
   @brief         Variance of a 32-bit fixed point vector for RV32IM extension.
