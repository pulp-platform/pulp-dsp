 ...
 * Title:        plp_var_q16s_xpulpv2.c
 * Description:  Kernel to calculate the variance of a 16-bit fixed point vector glue code on XPULPV2
 *
 * $Date:        30.06.2020
 *
...
/**
   @brief         Variance of a 16-bit fixed point vector for XPULPV2 extension.
