 ...
 * Title:        plp_std_q16s_xpulpv2.c
 * Description:  Kernel to calculate the standard deviation of a 16-bit fixed point vector glue code on XPULPV2
 *
 * $Date:        30.06.2020
 *
...
/**
   @brief         Standard deviation of a 16-bit fixed point vector for XPULPV2 extension.
