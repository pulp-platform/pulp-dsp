 ...
 * Title:        plp_var_q8.c
 * Description:  Variance of a 8-bit fixed point vector glue code
 *
 * $Date:        29.06.2020
 *
...
void plp_var_q8(const int8_t *__restrict__ pSrc,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID) {
        plp_var_q8s_rv32im(pSrc, blockSize, fracBits, pRes);
    } else {
        plp_var_q8s_xpulpv2(pSrc, blockSize, fracBits, pRes);
    }
}
