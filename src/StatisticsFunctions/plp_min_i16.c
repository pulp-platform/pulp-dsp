 ...
 * Title:        plp_min_i16.c
 * Description:  Minimum value of a 16-bit integer vector glue code
 *
 * $Date:        29.06.2020        
 *
...
/**
   @defgroup min Min
   Calculates the minimum of the input vector. Min is defined as the the greatest value in the vector.
...
void plp_min_i16(
  ...
  if (rt_cluster_id() == ARCHI_FC_CID){
    plp_min_i16s_rv32im(pSrc, blockSize, pRes);
  }
  else{
    plp_min_i16s_xpulpv2(pSrc, blockSize, pRes);
  }
