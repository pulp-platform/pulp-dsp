 ...
 * Title:        plp_conv_f32s_rv32im.c
 * Description:  32-bit floating-point single core convolution for RV32IM
 *
...
void plp_conv_f32s_rv32im(const float32_t *pSrcA,
    ...
    float32_t *pOut = pRes;                        /* Output pointer */
    ...
    float32_t temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8;
