 ...
 * Title:        plp_correlate_q16.c
 * Description:  Correlation glue code for 16-Bit fixed point vectors
 *
 * $Date:        03.07.2020        
 *
...
/**
   @brief Glue code for correlation of 16-bit fixed point vectors.
...
void plp_correlate_q16(
  ...
  if (rt_cluster_id() == ARCHI_FC_CID){
    plp_correlate_q16s_rv32im(pSrcA, srcALen, pSrcB, srcBLen, deciPoint, pRes);
  }
  else{
    plp_correlate_q16s_xpulpv2(pSrcA, srcALen, pSrcB, srcBLen, deciPoint, pRes);
  }
