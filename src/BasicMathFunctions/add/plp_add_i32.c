 ...
 * Title:        plp_add_i32.c
 * Description:  32-bit integer vector addition glue code
 *
 * $Date:        30. July 2020
 * $Revision:    V0
 *
...
/**
  ...
  This module contains the glue code for Vector Addition. The kernel codes (kernels) are in
  the Moducle Vector Addition Kernels.
...
void plp_add_i32(const int32_t * pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
      plp_add_i32s_rv32im(pSrcA, pSrcB, pDst, blockSize);
    } else {
      plp_add_i32s_xpulpv2(pSrcA, pSrcB, pDst, blockSize);
    }
}
