 ...
 * Title:        plp_mult_i32.c
 * Description:  32-bit integer vector multiplication glue code
 *
 * $Date:        30. July 2020
 * $Revision:    V0
 *
...
void plp_mult_i32(const int32_t * pSrcA,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID) {
      plp_mult_i32s_rv32im(pSrcA, pSrcB, pDst, blockSize);
    } else {
      plp_mult_i32s_xpulpv2(pSrcA, pSrcB, pDst, blockSize);
    }
}
