 ...
 * Title:        plp_cmplx_mult_real_q16.c
 * Description:  16-bit fixed-point complex by real multiplication
 *
 * $Date:        29. Jun 2020
 * $Revision:    V0
 *
...
/**
  @brief         16-bit fixed-point complex-by-real multiplication.
...
void plp_cmplx_mult_real_q16(
  ...
  if (rt_cluster_id() == ARCHI_FC_CID){
    plp_cmplx_mult_real_q16_rv32im(pSrcCmplx, pSrcReal, pDst, deciPoint, numSamples);
  }
  else{
    plp_cmplx_mult_real_q16_xpulpv2(pSrcCmplx, pSrcReal, pDst, deciPoint, numSamples);
  }
