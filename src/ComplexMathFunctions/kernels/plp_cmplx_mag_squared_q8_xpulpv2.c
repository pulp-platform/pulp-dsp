 ...
 * Title:        plp_cmplx_mag_squared_q8_xpulpv2.c
 * Description:  8-bit fixed-point squared magnitude glue code
 *
 * $Date:        13. July 2020
 * $Revision:    V0
 *
...
/**
  @brief         8-bit fixed-point complex magnitude squared.
        ...
        uint32_t numSamples)
{
  ...
  int8_t real, imag;                          /* Temporary input variables */
  ...
  while (blkCnt > 0U)
  {
    ...
    *pDst++ = __ROUNDNORM_REG(real * real, deciPoint) + __ROUNDNORM_REG(imag * imag, deciPoint);
