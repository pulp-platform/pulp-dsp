 ...
 * Description:  32-bit float complex by compplex multiplication
 *
 * $Date:        29. June 2020
 * $Revision:    V0
 *
...
/**
  ...
  @param[in]     pSrcA       points to complex input vector
  @param[in]     pSrcB       points to real input vector
  @param[out]    pDst        points to complex output vector
