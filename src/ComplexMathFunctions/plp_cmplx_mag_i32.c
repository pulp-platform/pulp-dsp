 ...
 * Title:        plp_cmplx_mag_i32.c
 * Description:  i32 complex magnitude
 *
 * $Date:        31. July 2020
 * $Revision:    V0
 *
...
void plp_cmplx_mag_i32(const int32_t *pSrc,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID){
        plp_cmplx_mag_i32s_rv32im(pSrc, pRes, numSamples);
    }
    else{
        plp_cmplx_mag_i32s_xpulpv2(pSrc, pRes, numSamples);
    }
}
