...
/**
  @brief Glue code for parallel strided matrix multiplication of 8-bit fix-point matrices.
  ...
  The output of the strided matrix multiplication will also be stored as an 8-bit array.
...
void plp_mat_mult_stride_q8_parallel(const int8_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_stride_instance_q8 args = { .pSrcA = pSrcA,
                                                 .pSrcB = pSrcB,
                                                 .M = M,
                                                 .N = N,
                                                 .O = O,
                                                 ...
                                                 .nPE = nPE,
                                                 .pDstC = pDstC };
        hal_cl_team_fork(nPE, plp_mat_mult_stride_q8p_xpulpv2, (void *)&args);
    }
}
