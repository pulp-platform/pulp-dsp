...
/**
  @brief Glue code for strided matrix multiplication of 32-bit floating-point matrices.
...
void plp_mat_mult_stride_f32(const float *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_stride_f32s_xpulpv2(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC, pDstC);
    }
}
