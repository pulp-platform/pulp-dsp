 ...
 * Title:        plp_mat_mult_stride_i16.c
...
void plp_mat_mult_stride_i16(const int16_t *__restrict__ pSrcA,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID) {
        plp_mat_mult_stride_i16s_rv32im(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC, pDstC);
    } else {
        plp_mat_mult_stride_i16v_xpulpv2(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC, pDstC);
    }
}
