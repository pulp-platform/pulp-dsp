 ...
 * Title:        plp_mat_mult_stride_i8_parallel.c
...
/**
  @brief Glue code for parallel strided matrix multiplication of 16-bit fix-point matrices.
  ...
  The output of the strided matrix multiplication will also be stored as an 16-bit array.
...
void plp_mat_mult_stride_q16_parallel(const int16_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_stride_instance_q16 args = { .pSrcA = pSrcA,
                                                  .pSrcB = pSrcB,
                                                  .M = M,
                                                  .N = N,
                                                  .O = O,
                                                  ...
                                                  .nPE = nPE,
                                                  .pDstC = pDstC };
        hal_cl_team_fork(nPE, plp_mat_mult_stride_q16p_xpulpv2, (void *)&args);
    }
}
