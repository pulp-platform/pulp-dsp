 ...
 * Title:        plp_mat_fill_I_stride_f32.c
 * Description:  32-bit floating-point strided identity matrix creation glue code
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
void plp_mat_fill_I_stride_f32(uint32_t N, uint32_t stride, float *__restrict__ pDst) {
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_fill_I_stride_f32s_xpulpv2(N, stride, pDst);
    }
}
