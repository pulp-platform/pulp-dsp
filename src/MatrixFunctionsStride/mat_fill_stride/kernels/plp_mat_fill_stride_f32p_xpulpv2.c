 ...
 * Title:        plp_mat_fill_stride_f32p_xpulpv2.c
 * Description:  parallel 32-bit floating-point strided matrix fill for XPULPV2
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
/**
  ...
  @param[in]  args  pointer to plp_mat_mat_fill_stride_instance_f32 struct initialized by
...
void plp_mat_fill_stride_f32p_xpulpv2(void *args) {
    ...
    plp_mat_fill_stride_instance_f32 *a = (plp_mat_fill_stride_instance_f32 *)args;
