 ...
 * Title:        plp_mat_sub_stride_f32_parallel.c
 * Description:  parallel 32-bit floating-point strided matrix subtraction glue code
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for parallel strided matrix subtraction of 32-bit floating-point matrices.
...
void plp_mat_sub_stride_f32_parallel(const float *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        hal_cl_team_fork(nPE, plp_mat_sub_stride_f32p_xpulpv2, (void *)&args);
    }
}
