 ...
 * Title:        plp_mat_mult_cmplx_stride_i16s_rv32im.c
 * Description:  16-bit complex strided matrix matrix multiplication kernel for RV32IM
 *
 * $Date:        18. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatMultCmplxStrideKernels Complex Matrix Matrix Multiplication Kernels
  This module contains the kernels for complex strided matrix matrix multiplication.
  ...
  `plp_mat_mult_cmplx_stride_i32s_xpulpv2`):
