 ...
 * Title:        plp_mat_mult_cmplx_stride_f32.c
 * Description:  32-bit floating-point complex strided matrix matrix multiplication glue code
 *
 * $Date:        18. July 2020
 * $Revision:    V0
 *
...
void plp_mat_mult_cmplx_stride_f32(const float *__restrict__ pSrcA,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_cmplx_stride_f32s_xpulpv2(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC,
                                               pDstC);
    }
}
