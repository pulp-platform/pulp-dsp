 ...
 * Title:        plp_mat_mult_cmplx_stride_f32_parallel.c
 * Description:  parallel 32-bit floating-point complex strided matrix matrix multiplication glue
 * code
 *
 * $Date:        18. July 2020
 * $Revision:    V0
...
void plp_mat_mult_cmplx_stride_f32_parallel(const float *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_cmplx_stride_instance_f32 args = { .pSrcA = pSrcA,
                                                        .pSrcB = pSrcB,
                                                        .M = M,
                                                        .N = N,
                                                        .O = O,
        ...
        hal_cl_team_fork(nPE, plp_mat_mult_cmplx_stride_f32p_xpulpv2, (void *)&args);
    }
}
