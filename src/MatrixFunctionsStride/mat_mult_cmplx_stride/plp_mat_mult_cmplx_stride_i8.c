 ...
 * Title:        plp_mat_mult_cmplx_stride_i8.c
...
void plp_mat_mult_cmplx_stride_i8(const int8_t *__restrict__ pSrcA,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID) {
        plp_mat_mult_cmplx_stride_i8s_rv32im(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC,
                                             pDstC);
    } else {
        plp_mat_mult_cmplx_stride_i8v_xpulpv2(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC,
                                              pDstC);
    }
}
