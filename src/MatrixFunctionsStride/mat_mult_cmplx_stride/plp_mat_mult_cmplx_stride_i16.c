 ...
 * Title:        plp_mat_mult_cmplx_stride_i16.c
...
/**
  @defgroup MatMultCmplxStride Complex Matrix Matrix Multiplication
  This module contains the glue code for complex strided matrix matrix multiplication. The kernel
  codes (kernels) are in the Module @ref MatMultCmplxStrideKernels.
...
void plp_mat_mult_cmplx_stride_i16(const int16_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        plp_mat_mult_cmplx_stride_i16s_rv32im(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC,
                                              pDstC);
    } else {
        plp_mat_mult_cmplx_stride_i16s_xpulpv2(pSrcA, pSrcB, M, N, O, strideA, strideB, strideC,
                                               pDstC);
    }
}
