 ...
 * Title:        plp_mat_add_stride_i32_parallel.c
 * Description:  parallel 16-bit integer strided matrix addition glue code
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for parallel strided matrix addition of 16-bit integer matrices.
...
void plp_mat_add_stride_i32_parallel(const int32_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_add_stride_instance_i32 args = { .pSrcA = pSrcA,
                                                 .pSrcB = pSrcB,
                                                 .M = M,
                                                 .N = N,
                                                 .strideA = strideA,
        ...
        hal_cl_team_fork(nPE, plp_mat_add_stride_i32p_xpulpv2, (void *)&args);
    }
}
