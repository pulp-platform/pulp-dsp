 ...
 * Title:        plp_mat_mult_trans_stride_i16_parallel.c
 * Description:  parallel 16-bit integer strided matrix multiplication glue code
 *
 * $Date:        14. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for parallel strided matrix multiplication of 16-bit integer matrices.
...
void plp_mat_mult_trans_stride_i16_parallel(const int16_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_stride_instance_i16 args = { .pSrcA = pSrcA,
                                                  .pSrcB = pSrcB,
                                                  .M = M,
                                                  .N = N,
                                                  .O = O,
                                                  ...
                                                  .nPE = nPE,
                                                  .pDstC = pDstC };
        hal_cl_team_fork(nPE, plp_mat_mult_trans_stride_i16p_xpulpv2, (void *)&args);
    }
}
