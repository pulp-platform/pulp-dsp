 ...
 * Title:        plp_mat_mult_trans_stride_q8vp_xpulpv2.c
...
/**
  ...
  The output of the strided matrix multiplication will also be stored as an 8-bit
...
void plp_mat_mult_trans_stride_q8vp_xpulpv2(void *args) {
    ...
    plp_mat_mult_stride_instance_q8 *a = (plp_mat_mult_stride_instance_q8 *)args;
