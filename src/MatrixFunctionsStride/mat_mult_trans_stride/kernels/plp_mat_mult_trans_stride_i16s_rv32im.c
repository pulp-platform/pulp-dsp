 ...
 * Title:        plp_mat_mult_trans_stride_i16s_rv32im.c
 * Description:  16-bit strided matrix multiplication kernel for RV32IM
 *
 * $Date:        14. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatMultTransStrideKernels Strided Matrix Transpose Matrix Multiplication Kernels
