 ...
 * Title:        plp_mat_mult_trans_stride_i16vp_xpulpv2.c
 * Description:  parallel 16-bit integer strided matrix multiplication for XPULPV2
 *
 * $Date:        14. July 2020
 * $Revision:    V0
 *
...
/**
   @brief Parallel strided matrix multiplication of 16-bit integer matrices kernel for XPULPV2
          extension.
   @param[in]  args  pointer to plp_mat_mult_stride_instance_i16 struct initialized by
                     plp_mat_mult_trans_stride_i16_parallel
   @return     none
...
void plp_mat_mult_trans_stride_i16vp_xpulpv2(void *args) {
    ...
    plp_mat_mult_stride_instance_i16 *a = (plp_mat_mult_stride_instance_i16 *)args;
