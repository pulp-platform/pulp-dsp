 ...
 * Title:        plp_mat_copy_stride_i16_parallel.c
...
void plp_mat_copy_stride_i16_parallel(const int16_t *__restrict__ pSrc,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_copy_stride_instance_i16 args = { .pSrc = pSrc,
                                                  .M = M,
                                                  .N = N,
                                                  .strideSrc = strideSrc,
                                                  .strideDst = strideDst,
        ...
        hal_cl_team_fork(nPE, plp_mat_copy_stride_i16p_xpulpv2, (void *)&args);
    }
}
