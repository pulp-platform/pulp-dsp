 ...
 * Title:        plp_mat_copy_stride_f32_parallel.c
 * Description:  parallel 32-bit floating-point strided matrix copy glue code
 *
 * $Date:        17. July 2020
 * $Revision:    V0
 *
...
void plp_mat_copy_stride_f32_parallel(const float *__restrict__ pSrc,
    ...
    if (rt_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_copy_stride_instance_f32 args = { .pSrc = pSrc,
                                                  .M = M,
                                                  .N = N,
                                                  .strideSrc = strideSrc,
                                                  .strideDst = strideDst,
