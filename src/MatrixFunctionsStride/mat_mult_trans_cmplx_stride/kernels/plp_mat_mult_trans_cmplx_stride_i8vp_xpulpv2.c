 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_i8vp_xpulpv2.c
 * Description:  parallel 8-bit integer complex strided matrix transpose matrix multiplication for
 * XPULPV2
 *
 * $Date:        18. July 2020
 * $Revision:    V0
...
/**
  @brief      parallel strided matrix transpose matrix multiplication for complex 8-bit integers on
              XpulpV2
  @param[in]  args    pointer to plp_mat_mat_mult_trans_cmplx_instance_i8 struct initialized by
...
void plp_mat_mult_trans_cmplx_stride_i8vp_xpulpv2(void *args) {
    ...
    plp_mat_mult_cmplx_stride_instance_i8 *a = (plp_mat_mult_cmplx_stride_instance_i8 *)args;
