 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_f32s_xpulpv2.c
 * Description:  32-bit floating-point complex strided matrix transpose matrix multiplication for
 * XPULPV2
 *
 * $Date:        18. July 2020
 * $Revision:    V0
...
/**
  @brief      Strided strided matrix transpose matrix multiplication for complex 32-bit floats on
              XpulpV2
