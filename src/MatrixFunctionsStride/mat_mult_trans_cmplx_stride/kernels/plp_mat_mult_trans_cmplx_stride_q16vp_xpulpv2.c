 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_q16vp_xpulpv2.c
 * Description:  parallel 16-bit fix-point complex strided matrix transpose matrix multiplication
 * for XPULPV2
 *
 * $Date:        18. July 2020
 * $Revision:    V0
...
/**
  ...
  on XpulpV2
  @param[in]  args    pointer to plp_mat_mat_mult_trans_cmplx_instance_q16 struct initialized by
...
void plp_mat_mult_trans_cmplx_stride_q16vp_xpulpv2(void *args) {
    ...
    plp_mat_mult_cmplx_stride_instance_q16 *a = (plp_mat_mult_cmplx_stride_instance_q16 *)args;
