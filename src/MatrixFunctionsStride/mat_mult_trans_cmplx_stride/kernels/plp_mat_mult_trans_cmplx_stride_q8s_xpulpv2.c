 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_q8s_xpulpv2.c
 * Description:  8-bit fix-point complex strided matrix transpose matrix multiplication for XPULPV2
 *
 * $Date:        18. July 2020
 * $Revision:    V0
 *
...
/**
  @brief      Strided strided matrix transpose matrix multiplication for complex 8-bit fix-point on
              XpulpV2
