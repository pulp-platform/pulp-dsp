 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_q32s_xpulpv2.c
 * Description:  32-bit fix-point complex strided matrix transpose matrix multiplication for XPULPV2
 *
 * $Date:        18. July 2020
 * $Revision:    V0
 *
...
/**
  @brief      Strided strided matrix transpose matrix multiplication for complex 32-bit fix-point on
              XpulpV2
