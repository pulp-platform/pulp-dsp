 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_i16s_rv32im.c
 * Description:  16-bit complex strided matrix transpose matrix multiplication kernel for RV32IM
 *
 * $Date:        18. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatMultTransCmplxStrideKernels Complex Matrix Transpose Matrix Multiplication Kernels
  This module contains the kernels for complex strided matrix transpose matrix multiplication.
  ...
  `plp_mat_mult_trans_cmplx_stride_i32s_xpulpv2`):
...
/**
  @brief      Strided strided matrix transpose matrix multiplication for complex 16-bit integers on
  RV32IM
