 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_q32_parallel.c
...
void plp_mat_mult_trans_cmplx_stride_q32_parallel(const int32_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_cmplx_stride_instance_q32 args = { .pSrcA = pSrcA,
                                                        .pSrcB = pSrcB,
                                                        .M = M,
                                                        .N = N,
                                                        .O = O,
        ...
        hal_cl_team_fork(nPE, plp_mat_mult_trans_cmplx_stride_q32p_xpulpv2, (void *)&args);
    }
}
