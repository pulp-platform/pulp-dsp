 ...
 * Title:        plp_mat_mult_trans_cmplx_stride_i32_parallel.c
 * Description:  parallel 16-bit integer complex strided matrix transpose matrix multiplication glue
 * code
 *
 * $Date:        18. July 2020
 * $Revision:    V0
...
void plp_mat_mult_trans_cmplx_stride_i32_parallel(const int32_t *__restrict__ pSrcA,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_mult_cmplx_stride_instance_i32 args = { .pSrcA = pSrcA,
                                                        .pSrcB = pSrcB,
                                                        .M = M,
                                                        .N = N,
                                                        .O = O,
        ...
        hal_cl_team_fork(nPE, plp_mat_mult_trans_cmplx_stride_i32p_xpulpv2, (void *)&args);
    }
}
