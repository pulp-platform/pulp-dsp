 ...
 * Title:        plp_mat_scale_stride_i32_parallel.c
 * Description:  parallel 16-bit integer strided matrix scale glue code
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for parallel strided matrix scale of 16-bit integer matrices.
...
void plp_mat_scale_stride_i32_parallel(const int32_t *__restrict__ pSrc,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_scale_stride_instance_i32 args = { .pSrc = pSrc,
                                                   .M = M,
                                                   .N = N,
                                                   .strideSrc = strideSrc,
                                                   .strideDst = strideDst,
        ...
        hal_cl_team_fork(nPE, plp_mat_scale_stride_i32p_xpulpv2, (void *)&args);
    }
}
