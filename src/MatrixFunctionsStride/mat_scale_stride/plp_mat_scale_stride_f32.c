 ...
 * Title:        plp_mat_scale_stride_f32.c
 * Description:  32-bit floating-point strided matrix scale glue code
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief Glue code for strided matrix scale of 32-bit floating-point matrices.
...
void plp_mat_scale_stride_f32(const float *__restrict__ pSrc,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_scale_stride_f32s_xpulpv2(pSrc, M, N, strideSrc, strideDst, scaleFactor, pDst);
    }
}
