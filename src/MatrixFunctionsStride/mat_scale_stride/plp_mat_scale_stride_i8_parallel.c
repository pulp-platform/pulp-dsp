 ...
 * Title:        plp_mat_scale_stride_i8_parallel.c
...
void plp_mat_scale_stride_i8_parallel(const int8_t *__restrict__ pSrc,
    ...
    if (hal_cluster_id() == ARCHI_FC_CID) {
        ...
        plp_mat_scale_stride_instance_i8 args = { .pSrc = pSrc,
                                                  .M = M,
                                                  .N = N,
                                                  .strideSrc = strideSrc,
                                                  .strideDst = strideDst,
        ...
        hal_cl_team_fork(nPE, plp_mat_scale_stride_i8p_xpulpv2, (void *)&args);
    }
}
