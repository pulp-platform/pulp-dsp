 ...
 * Title:        plp_mat_scale_stride_i16vp_xpulpv2.c
 * Description:  parallel 16-bit integer strided matrix scale for XPULPV2
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
void plp_mat_scale_stride_i16vp_xpulpv2(void *args) {
    ...
    plp_mat_scale_stride_instance_i16 *a = (plp_mat_scale_stride_instance_i16 *)args;
