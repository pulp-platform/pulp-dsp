 ...
 * Title:        plp_mat_scale_stride_i8v_xpulpv2.c
 * Description:  8-bit integer strided matrix scale for XPULPV2
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief strided matrix scale of 8-bit integer matrices kernel for XPULPV2 extension.
