 ...
 * Title:        plp_mat_scale_stride_i32s_rv32im.c
 * Description:  32-bit strided matrix scale kernel for RV32IM
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief strided matrix scale of 32-bit integer matrices kernel for RV32IM extension.
