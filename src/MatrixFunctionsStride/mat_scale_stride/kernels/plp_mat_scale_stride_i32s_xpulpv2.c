 ...
 * Title:        plp_mat_scale_stride_i32s_xpulpv2.c
 * Description:  32-bit integer strided matrix scale for XPULPV2
 *
 * $Date:        6. July 2020
 * $Revision:    V0
 *
...
/**
  @brief strided matrix scale of 32-bit integer matrices kernel for XPULPV2 extension.
